...
public class TrustedUsersPage extends JFrame implements Notifications {
    ...
    public TrustedUsersPage(String title, Client client) {
        super(title);
    ...
    private void setupTrustedUsersTable() {
        ...
        List<User> trustedUsers = ClientController.getTrustedUsers(client);
    ...
    private void handleRemoveTrustedUser(User user) {
        ...
        Request request = new AuthorizedRequest(Method.REMOVE_TRUSTED_USER, client.getToken(), MiscUtils.toJson(jsonObject));
    ...
    private void handleAddUserClicked() {
        ...
        Request request = new AuthorizedRequest(Method.ADD_TRUSTED_USER, client.getToken(), MiscUtils.toJson(jsonObject));
        GenericResponse response = client.sendAndReceive(request);
